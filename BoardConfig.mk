...
DEVICE_PATH := device/samsung/a10eu
...
# Kernel
TARGET_PREBUILT_KERNEL := device/samsung/a10eu/prebuilt/Image
BOARD_PREBUILT_DTBOIMAGE := device/samsung/a10eu/prebuilt/recovery_dtbo
...
BOARD_MKBOOTIMG_ARGS += --header_version $(BOARD_BOOT_HEADER_VERSION) --pagesize $(BOARD_KERNEL_PAGESIZE) --board "SC42AOMU1BVH1"
BOARD_MKBOOTIMG_ARGS += --recovery_dtbo $(BOARD_PREBUILT_DTBOIMAGE)
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/a10eu/bootimg.mk
